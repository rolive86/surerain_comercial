/**
 * Create or link admin.demo@surerain.test (Auth + app_user_links).
...
async function main() {
  ...
  const email = process.env.DEMO_ADMIN_EMAIL ?? "admin.demo@surerain.test";
  ...
  console.log(JSON.stringify({ email, user_id: userId, role: "admin" }, null, 2));
}
