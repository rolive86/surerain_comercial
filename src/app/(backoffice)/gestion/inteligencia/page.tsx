...
export default async function InteligenciaPage({
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="font-display text-3xl font-bold text-sr-ink">Inteligencia</h1>
      ...
      <form className="mb-6 grid gap-3 rounded-xl border border-black/5 bg-white p-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="overflow-x-auto rounded-xl border border-black/5 bg-white">
            <table className="min-w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-black/5">
                {recontact.length === 0 ? (
                  <tr>
                    <td colSpan={7} className="px-4 py-8 text-center text-sr-ink/45">
                ...
                <table className="min-w-full text-left text-sm">
                  ...
                  <tbody className="divide-y divide-black/5">
                    {comparativo.length === 0 ? (
                      <tr>
                        <td colSpan={5} className="px-4 py-8 text-center text-sr-ink/45">
